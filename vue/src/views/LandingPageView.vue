    ...
    <section class="hero">
        <div class="container">
            <header class="hero-header">
                <div class="desktop-hero-header desktop" dir="rtl">
                    <router-link
                        class="seller-login"
                        :to="{ name: 'landingPage' }"
                    >
                    ...
                    <button @click="openPopup" dir="rtl" class="login-btn">
                        ورود
                        <span style="margin-right: 0; margin-left: 3px">یا</span
                        >عضویت
                    </button>
                </div>
                <svg
            ...
            <p class="site-description" dir="rtl">
                سفارش آنلاین غذا ، میوه، نان، شیرینی و ...
            </p>
            <div class="address-select" dir="rtl">
                <div class="address-select-text">
                    ...
                    <p>ابتدا آدرستان را انتخاب کنید.</p>
                </div>
                <button class="address-select-btn">
                    <svg
                        fill="white"
                        width="17"
                        height="17"
...
h1 {
    font-size: clamp(1rem, 3vw + 1rem, 3.3rem);
    font-weight: 600;
    line-height: 1.3;
    color: rgb(58, 61, 66);
...
.hero-header {
    ...
    margin-bottom: clamp(2em, 7vw, 9em);
}
