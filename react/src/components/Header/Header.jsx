        ...
        <>
                ...
                <div>
                    <div className="topbar">
                        ...
                        <div className="topbar__left">
                            <div className="topbar__left-seller">
                                <a
                                    target="_blank"
                                    href="#"
                                    className="seller__link"
                                >
                                    <button dir="rtl" className="seller__btn">
                                        <svg
                                            width="24"
                                            height="26"
                                            viewBox="0 0 24 26"
                                        ...
                                        <span className="seller__txt">
                                            ثبت نام فروشندگان
                                        </span>
                                    </button>
                                </a>
                            </div>
                            <div className="topbar__left-customer">
                                <button
                                    className="customer__btn"
                                    onClick={() => handleShow()}
                                >
                                    <span className="customer__login">
                                        ورود
                                    </span>
                                    <span className="customer__ortext">
                                        {" "}
                                        یا{" "}
                                    </span>
                                    <span className="customer__register">
                                        عضویت
                                    </span>
                                </button>
                            </div>
                    ...
                    <div className="main__header">
                        <div className="online__order">
                            <p className="online__order-title">سفارش آنلاین</p>
                            <div className="online__order-order">نان</div>
                        </div>
                        <div className="online__order-subtitle">
                            <h1 className="online__order-subtitle--header">
                                سفارش آنلاین غذا
                            </h1>
                            <p className="online__order-subtitle--header">
                                میوه، نان، شیرینی و ...
                            </p>
                        </div>
                        <div className="main__header-searchbox">
                            <div className="searchbox__placeholder-txt">
                                <svg
                                    className="searchbox__placeholder-svg"
                                    width="17"
                                    height="20"
                                    viewBox="0 0 12 14"
                                ...
                                <p className="searchbox__placeholder-paragraph">
                                    ابتدا آدرس را انتخاب کنید
                                </p>
                            </div>
            ...
            <Modal className="modal" show={show} onHide={handleClose}>
                <Modal.Header className="modal-header">
                    <Modal.Title className="modal-title__right">
                        ورود یا عضویت
                    </Modal.Title>
                    <Modal.Title className="modal-title__left">
                        <svg className="modal-topbar__left-svg"
                            xmlns="http://www.w3.org/2000/svg"
                            width="3.5rem"
                            height="1.75rem"
                            viewBox="0 0 56 28"
                ...
                <Modal.Body>
                    <Form className="modal-form">
                        <Form.Group
                            className="mb-3 modal-form-label"
                            controlId="exampleForm.ControlInput1"
                        >
                            <Form.Label>ایمیل</Form.Label>
                            <Form.Control className="modal-form-input"  type="email" autoFocus />
                        </Form.Group>
                    </Form>
                </Modal.Body>
                <Modal.Footer>
